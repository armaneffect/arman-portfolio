      ...
      <div className='grid lg:grid-cols-4 md:grid-cols-2 mt-5 p-2 gap-8 pb-10'>
        ...
        <div data-aos="zoom-in" className='border-[#2A1454] hover:bg-[#2A1454] group bg-[#140C1C] border hover:border-[#543a8b] flex justify-center items-center hover:shadow-sm hover:shadow-[#A074F9]  py-4 mt-3 rounded-2xl duration-300'>
          <div className='flex flex-col items-center justify-center'>
            ...
            <span className='text-7xl text-center'> <FaPhp className='group-hover:text-[#4F5B93] text-gray-500' /></span>
            <h1 className='text-xl text-[#543a8b] text-center group-hover:text-[#A074F9] my-auto'>PHP</h1>
          </div>
        </div>
        <div data-aos="zoom-in" className='border-[#2A1454] hover:bg-[#2A1454] group bg-[#140C1C] border hover:border-[#543a8b] flex justify-center items-center hover:shadow-sm hover:shadow-[#A074F9]  py-4 mt-3 rounded-2xl duration-300'>
          <div className='flex flex-col items-center justify-center'>
        ...
        <div data-aos="zoom-in" className='border-[#2A1454] hover:bg-[#2A1454] group bg-[#140C1C] border hover:border-[#543a8b] flex justify-center items-center hover:shadow-sm hover:shadow-[#A074F9]  py-4 mt-3 rounded-2xl duration-300'>
          <div className='flex flex-col items-center justify-center'>
            ...
            <span className='text-6xl text-center'> <DiSqllite className='group-hover:text-[#3E6E93] text-gray-500' /></span>
            <h1 className='text-xl text-[#543a8b] text-center group-hover:text-[#A074F9] my-auto'>SQLite</h1>
          </div>
        </div>
        ...
        <div data-aos="zoom-in" className='border-[#2A1454] hover:bg-[#2A1454] group bg-[#140C1C] border hover:border-[#543a8b] flex justify-center items-center hover:shadow-sm hover:shadow-[#A074F9]  py-4 mt-3 rounded-2xl duration-300'>
          <div className='flex flex-col items-center justify-center'>
            ...
            <span className='text-6xl text-center'> <AiTwotoneApi className='group-hover:text-[#084161] text-gray-500' /></span>
            <h1 className='text-xl text-[#543a8b] text-center group-hover:text-[#A074F9] my-auto'>API</h1>
          </div>
        </div>
        <div data-aos="zoom-in" className='border-[#2A1454] hover:bg-[#2A1454] group bg-[#140C1C] border hover:border-[#543a8b] flex justify-center items-center hover:shadow-sm hover:shadow-[#A074F9]  py-4 mt-3 rounded-2xl duration-300'>
          <div className='flex flex-col items-center justify-center'>
