            ...
            <div className='md:flex p-5 border rounded-2xl group border-[#2A1454]  pb-10 '>
                ...
                <div>
                    ...
                    <div className='sm:flex mt-5 items-center'>
                        <a href="https://drive.google.com/file/d/1YigPFqxMlIueU7Bb9tduh_GH1m1WDEX2/view?usp=sharing"  className='inline-flex items-center px-6 py-3 rounded-4xl border duration-300 border-[#8750F7] hover:bg-transparent bg-[#8750F7]  hover:text-gray-300 ml-10 mt-5'>
                            Hire Me!
